...
import com.EgerEats.app.Delivery_FoodPanelBottomNavigation;
    ...
    private void Shipped() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                grandtotal.setText("Ksh " + deliveryShipFinalOrders1.getGrandTotalPrice());
                Address.setText(deliveryShipFinalOrders1.getAddress());
                Custname.setText(deliveryShipFinalOrders1.getName());
                MobileNumber.setText("+254" + deliveryShipFinalOrders1.getMobileNumber());
