...
import com.EgerEats.app.ReusableCode.ReusableCodeForAll;
import com.EgerEats.app.SendNotification.APIService;
import com.EgerEats.app.SendNotification.Client;
import com.EgerEats.app.SendNotification.Data;
import com.EgerEats.app.SendNotification.MyResponse;
import com.EgerEats.app.SendNotification.NotificationSender;
...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DeliveryPendingOrderFragmentAdapter.ViewHolder holder, int position) {
        ...
        holder.mobilenumber.setText("+254" + deliveryShipOrders1.getMobileNumber());
        holder.grandtotalprice.setText("Grand Total: Ksh " + deliveryShipOrders1.getGrandTotalPrice());
