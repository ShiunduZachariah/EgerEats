...
public class CustomerCartAdapter extends RecyclerView.Adapter<CustomerCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.PriceRs.setText("Price: Ksh " + cart.getPrice());
        holder.Qty.setText("× " + cart.getDishQuantity());
        holder.Totalrs.setText("Total: ksh " + cart.getTotalprice());
        ...
        CustomerCartFragment.grandt.setText("Grand Total: Ksh " + total);
